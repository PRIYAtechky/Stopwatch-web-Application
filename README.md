...
2. **Start** the stopwatch by clicking the "Start" button.
3. **Pause** the stopwatch at any time using the "Pause" button.
4. **Reset** the stopwatch to zero by clicking the "Reset" button.
5. Track laps or intervals using the "Lap" button. Each lap time will be displayed below the stopwatch.
